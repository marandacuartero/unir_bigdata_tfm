...
public abstract class DataWriter {
	...
	abstract int cleanFrom(Date fecha) throws SQLException;
	abstract void saveTrazas(TrazaTorneo[] trazaTorneos) throws SQLException;
	
	int _cleanFrom(Date fecha) throws SQLException {
	...
	void _saveTrazas(TrazaTorneo[] trazaTorneos) throws SQLException {
